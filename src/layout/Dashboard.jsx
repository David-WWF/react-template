  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, width: { sm: `calc(100% - ${drawerWidth}px)` } }}>
        ...
        {view === 'Inicio' && <Typography>Bienvenido. Selecciona algo en el menú.</Typography>}
        {view === 'Botones' && <Typography>Aquí pondrás tus botones pronto...</Typography>}
        {view === 'Tarjetas' && <Typography>Aquí pondrás tus cards pronto...</Typography>}
      </Box>
    </Box>
  );
}